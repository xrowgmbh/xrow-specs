...
sed -i 's@<str name=\"confFiles\">.*@<str name=\"confFiles\">schema.xml,elevate.xml,stopwords.txt</str>@g' $RPM_BUILD_ROOT%{_datadir}/ezfind/solr/ezp-default/conf/schema.xml
