...
Requires: php
Requires: php-devel php-bcmath php-devel php-enchant php-fpm php-gd php-imap php-intl php-ldap php-mbstring php-mysql php-pdo php-pear php-process php-pspell php-soap php-tidy php-xml php-xmlrpc
