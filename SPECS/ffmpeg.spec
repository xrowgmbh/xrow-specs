...
Requires: imlib2-devel, SDL-devel, freetype-devel, zlib-devel, pkgconfig, yasm
%{!?_without_a52dec:Requires: a52dec-devel}
%{!?_without_dc1394:Requires: libdc1394-devel}
Requires: libvo-aacenc-devel
...
%{!?_without_opencore_amr:--enable-libopencore-amrnb --enable-libopencore-amrwb --enable-version3} \
